...
export const SERVICES_MOCK: IService2[] = [
  {
    id: 1,
  ...
  {
    id: 9,
    nombre: "Pasadía Cafam Melgar",
    slug: "pasadia_cafam_melgar",
    descripcion:
      "Déjate llevar por la Montaña Rusa Acuática, la Piscina de Olas y los toboganes extremos Medusa, Hidras y Dragón Rojo. Empápate, sumérgete y disfruta.",
    tipo: "turismo",
    categorias: ["A", "B", "C", "D"],
    precios: [14000, 58600, 134600, 164999],
    objetivo:
      "Pasar un tiempo en familia disfrutando del centro de vacaciones más grande del país",
    requisitos: [
      "Tarifa desde $11.800 aplica para temporada baja a partir del 15 de julio de 2024.",
      "Al momento de hacer el ingreso se verificará la reserva del portador en el sistema.",
      "No está permitido el ingreso de mascotas al Parque Acuático.",
    ],
    recomendaciones: [
      "Contamos con servicio de locker con candado, estos candados tienen un valor de $9.000. En el momento del check in se confirmarán los puntos donde se pueden adquirir. ",
      "Te recomendamos dejar en el locker las pertenencias y portar lo necesario para disfrutar esta experiencia.",
      "Para disfrutar de las piscinas y atracciones del Parque Acuático, es obligatorio el uso de gorro de baño que tiene un costo $3.200. Los puntos autorizados de venta del gorro son todas las fuentes de soda del Centro de Vacaciones Cafam Melgar.",
    ],
    fechaCreacion: "27/10/2020",
    imagenes: ["melgar.png", "melgar2.jpg"],
    esCanjeable: false,
    puntosCanjeables: 0,
  },
];
