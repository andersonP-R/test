...
export const SelectCenterGifs = ({ service }: Props) => {
  ...
  return (
    <div className="">
      <div className="flex flex-col overflow-hidden">
        <span className="text-bold text-2xl pb-2 mb-1 px-4 text-primary-800">
          Sedes disponibles
        </span>
        {/* tab navigation */}
        <div className="flex snap-x snap-mandatory w-full overflow-scroll mb-2 gap-4 ml-4">
